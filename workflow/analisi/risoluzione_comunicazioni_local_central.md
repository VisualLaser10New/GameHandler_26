...
- Test: `RegisterLocalServerAdapterWireMockTest` (WireMock stub `POST /internal/servers/register` 201), `LocalServerRegistrationServiceTest` (verifica retry fin直到 successo), `LocalServerRegistryIdempotentRegisterTest` (seconda chiamata register non duplica).
