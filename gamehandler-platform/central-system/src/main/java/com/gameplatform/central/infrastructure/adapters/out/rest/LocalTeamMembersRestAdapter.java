...
/**
 * Pushes {@code TEAM_MEMBERS_UPSERTED} events to a single local server's
 * {@code PUT /internal/tournaments/teams/members/sync} endpoint. Structural
 * twin of {@link LocalTournamentParticipantsRestAdapter} (same SSLContext
 * wiring, timeouts, {@code X-Internal-Api-Key} header, {@link RetryTemplate} 3
 * attempts).
 *
 * <p>The request body is {@code List<TeamMembersEventDto>}; the receiver
