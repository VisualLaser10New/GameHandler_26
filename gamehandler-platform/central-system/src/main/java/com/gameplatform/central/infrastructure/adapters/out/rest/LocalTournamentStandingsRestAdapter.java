...
/**
 * Adapter REST che invia eventi {@code TOURNAMENT_STANDINGS_UPSERTED} al local
 * server tramite l'endpoint {@code PUT /internal/tournaments/standings/sync}.
 *
 ...
 * {@code List<TournamentStandingsEventDto>}; l'upsert lato ricevente &egrave;
 ...
 * @see PushTournamentStandingsToLocalServersPort
 */
@Component
public class LocalTournamentStandingsRestAdapter implements PushTournamentStandingsToLocalServersPort {
    ...
    /**
     * Invia una lista di eventi di classifica torneo al local server specificato
     ...
     * originale.
     *
     * @param events la lista degli eventi di classifica torneo da inviare; non deve essere {@code null}
