...
('chess-machine-1',   'CHESS',       'Chess Table 1',    'building-2', 'AVAILABLE'),
('foosball-machine-1','FOOSBALL',    'Foosball Table 1', 'building-2', 'AVAILABLE'),
('darts-machine-1',   'DARTS',       'Darts Board 1',    'building-2', 'AVAILABLE'),
('slot-machine-1',    'SLOT_MACHINE','Slot Machine 1',   'building-2', 'AVAILABLE');
