...
('game-chess-2',   'CHESS',       'Chess Table 1',    'building-2', 'AVAILABLE'),
('game-foosball-2','FOOSBALL',    'Foosball Table 1', 'building-2', 'AVAILABLE'),
('game-darts-2',   'DARTS',       'Darts Board 1',    'building-2', 'AVAILABLE'),
('game-slot-2',    'SLOT_MACHINE','Slot Machine 1',   'building-2', 'AVAILABLE');
